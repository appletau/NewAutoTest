...
#import "UI.h"
#import <IACFactoryFramework/IACFactoryFramework.h>
...
- (void)initMainUI
{
    ...
    [_uiOutlet setHideBigStartBtn:ctrlMode==TempSn?YES:NO];
    ...
    [_uiOutlet setTemp_sn_hidden:!_uiOutlet.hideBigStartBtn];
